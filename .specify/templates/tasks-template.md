...
**Project Constitution Note**: For this repository, generated tasks MUST stay within Phase 1
real-data baseline work unless the constitution is amended. Tasks MUST include dataset
normalization or split-protection work, baseline evaluation or experiment logging work, and
failure-analysis tasks when those outputs are part of the spec. Do not add Omniverse, Isaac
Sim, synthetic-data, or mixed-data retraining tasks to a Phase 1 implementation plan.
...
- [ ] T004 Define experiment logging location and result artifact format
...
- [ ] T011 Define dataset ontology, label mapping, and split-freeze procedure
- [ ] T012 Create baseline evaluation script or notebook scaffold
- [ ] T013 Define failure-analysis report format for baseline runs
...
- [ ] T021 [US1] Capture baseline metrics and failure examples for user story 1
